import './index.scss'
import LogoJ from '../../assets/images/logo-jordan.png'
import LogoSubtitle from '../../assets/images/Jordan.png'
  ...
  return (
    <div className="nav-bar">
      ...
      <ul>
        ...
        <li>
          <a
            href="https://github.com/JordanGallant"
            target="_blank"
            rel="noreferrer"
          >
        ...
        <li>
          <a
            href="https://twitter.com/jgsleepwithme"
            rel="noreferrer"
            target="_blank"
          >
